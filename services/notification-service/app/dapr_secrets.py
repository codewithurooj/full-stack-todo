"""
Dapr Secrets Module for Notification Service
...
class DaprSecretsClient:
    ...
    async def get_vapid_keys(self) -> tuple[Optional[str], Optional[str]]:
        ...
        private = await self.get_secret(
            "app-secrets", "VAPID_PRIVATE_KEY", "VAPID_PRIVATE_KEY"
        )
        public = await self.get_secret(
            "app-secrets", "VAPID_PUBLIC_KEY", "VAPID_PUBLIC_KEY"
        )
