...
class Settings(BaseSettings):
    ...
    CONSUMER_GROUP_ID: str = os.getenv("CONSUMER_GROUP_ID", "audit-service-group")
    ...
    BATCH_SIZE: int = 100  # Commit offset every N events
    BATCH_TIMEOUT_SECONDS: float = 10.0  # Or every N seconds

    # Dapr Settings (Feature 012)
    DAPR_HOST: str = os.getenv("DAPR_HOST", "localhost")
    DAPR_HTTP_PORT: int = int(os.getenv("DAPR_HTTP_PORT", "3503"))
