...
**Purpose**: Generate production-ready, accessible UI components and layout templates for Next.js projects with Tailwind CSS, following Shadcn design patterns.

**When to Use**: After setting up Next.js frontend, use this skill to generate professional UI components, layouts, and theming before building features.

**Time Saving**: Manual component development: 3-5 hours → With this skill: 20-30 minutes (90-95% time saved)
...
**File**: `frontend/components/ui/motion.tsx`
```typescript
"use client";
...
### Example 1: Complete Login Page with Theme
...
### Example 2: Dashboard with Layout
...
- [x] Checkbox
- [x] Switch
- [x] Select (Trigger, Content, Item)
- [x] Dialog (Overlay, Content, Header, Title, Description)
- [x] Toast (Provider, Viewport, Title, Description, Action)
- [x] Alert (3 variants, Title, Description)
- [x] Skeleton
- [x] Separator
- [x] Tabs (List, Trigger, Content)
- [x] Table (Header, Body, Row, Head, Cell)
- [x] Dropdown Menu (Trigger, Content, Item, Label, Separator)
- [x] Dashboard Layout (Sidebar, Header, Content)
- [x] Theme Toggle (Dark/Light mode)
- [x] Utility functions (cn, formatDate, truncate)
...
**Time Savings**:
- Manual UI development: 3-5 hours
- With this skill: 20-30 minutes
- **90-95% time reduction**

**Quality Improvements**:
- Consistent design system across all pages
- Fully accessible components (ARIA labels, keyboard navigation)
